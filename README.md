...
📂 Data Description
The analysis is based on the NYC 311 Service Requests dataset, one of the largest open city datasets available through NYC Open Data. It contains millions of records of citizen complaints and service requests logged since 2010.
...
View the report  
Check NYC311_project.pdf for a summarized version of the findings.

👩‍💻 Author
Nivedha Sivakumar

🌐 GitHub : NivedhaSiva
💼 LinkedIn : Nivedha Sivakumar
